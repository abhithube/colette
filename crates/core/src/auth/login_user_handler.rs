...
use super::{AuthConfig, Claims, LOCAL_PROVIDER, TokenData, TokenType};
use crate::{
...
impl Handler<LoginUserCommand> for LoginUserHandler {
    ...
    async fn handle(&self, data: LoginUserCommand) -> Result<Self::Response, Self::Error> {
            ...
            .await?
        {
            ...
            None => Err(LoginUserError::NotAuthenticated),
        }?;
