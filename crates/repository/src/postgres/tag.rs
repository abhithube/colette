...
impl Creatable for PostgresTagRepository {
    ...
    async fn create(&self, data: Self::Data) -> Self::Output {
        crate::tag::insert(&self.pool, data.title.clone(), data.user_id)
            .await
            .map_err(|e| match e {
...
impl Updatable for PostgresTagRepository {
    ...
    async fn update(&self, params: Self::Params, data: Self::Data) -> Self::Output {
        if data.title.is_some() {
            crate::tag::update(&self.pool, params.id, params.user_id, data.title)
                .await
                .map_err(|e| match e {
...
impl Deletable for PostgresTagRepository {
    ...
    async fn delete(&self, params: Self::Params) -> Self::Output {
        crate::tag::delete(&self.pool, params.id, params.user_id)
            .await
            .map_err(|e| match e {
                sqlx::Error::RowNotFound => Error::NotFound(params.id),
                _ => Error::Unknown(e.into()),
