...
export const Root = (props: RootProps) => (
  <Dialog.Root data-scope="sheet" {...props} />
)

export type TriggerProps = Dialog.TriggerProps

export const Trigger = (props: TriggerProps) => (
  <Dialog.Trigger data-scope="sheet" {...props} />
)
...
export const Content = ({
  ...
  return (
    <Portal>
      ...
      >
        {children}
        <Dialog.CloseTrigger className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
          <X className="size-4" />
